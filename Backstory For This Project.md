...
I missed old PC games and the charm of old Windows 2000. I wanted to experience old games from my childhood on a Windows 2000 virtual machine and begin acquiring a physical collection of old PC games to play from disc. However found it problematic to play these old games via various virtual machines without running into a myriad of issues. I tried VirtualBox, 86Box, Hyper-V, even PCem, but ran into different kinds of issues when trying to maximize game performance and compatibility. I finally landed on VMware Workstation Pro as it was the only one I could get decent enough performance out of. But I ran into an issue; Windows 2000 specifically was getting capped at 64MB by the VMware graphics driver.

I have no experience coding or reverse engineering however I noticed there was a problem that has existed for a decade and no fix has ever been provided. After hours of deliberate tinkering with Ghidra on multiple different patch drafts, various PowerShell commands, failing checksums and the great help of AI for reverse engineering, I was able to successfully patch the problematic VMware SVGA II "vmx_svga.sys" driver with a two-byte patch to correctly reflect the higher VRAM in the Windows 2000 now, specifically the driver's architectural maximum of 128MB.
For me, this was a deliberate effort to help further the preservation of retro PC gaming in whatever way I could, no matter how small. In my view, one of the big problems that we will one day face with retro gaming is that retro PC parts are becoming less and less available by the year and top notch parts from the era are not cheap for their relative age. Things break down, capacitors/power supplies blow, old hard drives go kaput. One day there will no longer be an affordable or viable option for building a proper retro gaming PC so I hope virtualization can help.
